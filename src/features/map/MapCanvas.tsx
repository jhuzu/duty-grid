...
export type MapDutyPoint = { id: string; pointCode: string; pointName: string; note?: string | null; color: string; pointType: "duty" | "hollow" | "signal"; latitude: number; longitude: number };
